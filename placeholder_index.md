...
<header class="hero">
  ...
  <p class="subtagline">// local-first · deterministic controls · human gates · 200/200 tests passing</p>
  <div class="cta-group">
...
<div class="container">
  <div class="stats">
    <div class="stat"><span class="stat-value">200</span><span class="stat-label">Smoke Tests Passing</span></div>
    <div class="stat"><span class="stat-value">6</span><span class="stat-label">Security Checks (Guardian)</span></div>
...
<div class="container">
  ...
  <p style="color: var(--dim); margin-bottom: 1.5rem;">A standalone FastAPI process (<code>:9766</code>) with a deterministic-only 6-check pipeline. No LLM calls. Unpoisonable. Fails safe to <strong>halt</strong> on any error.</p>
  <div class="grid-3">
    <div class="card">
...
<div class="container">
  ...
  <div class="threat-grid">
    ...
    <div class="threat-card">
      ...
      <div class="threat-def">Sanitizer (20 regex patterns) + RAG provenance scoring</div>
    </div>
    <div class="threat-card">
...
<div class="container">
  ...
  <div class="phase-list">
    ...
    <div class="phase-row" style="border-color: #f9c74f33;">
      <div class="phase-num" style="color: #f9c74f;">Phase 6</div>
      <div class="phase-desc">PentestAgent — air-gapped red-team bot, continuous security regression suite</div>
...
<span class="comment"># ✓ 200 passed in ~2s</span><br>
<br>
...
<div class="container">
  ...
  <p style="color: var(--dim);">
    The codebase is currently in hardening. The private development repository is at
    <a href="https://github.com/LegionForge/LegionForge" style="color: var(--accent2);">LegionForge/LegionForge</a>
    and will be published here at v1.0.
  </p>
  <p style="color: var(--dim);">
    <strong style="color: var(--text);">Watch this repository</strong> or check back at
    <a href="https://legionforge.org" style="color: var(--accent2);">legionforge.org</a> for the public release.
    Questions and pre-launch interest can be filed as
