...
_RESEARCHER_SYSTEM_CONTENT = (
    ...
    "- web_fetch(url): fetch a plain web page (fast). Try this FIRST for any URL.\n"
    "- web_fetch_js(url): fetch a page that requires JavaScript to render content.\n"
    "  Use ONLY when web_fetch returns empty or skeletal HTML (SPAs, React/Vue apps).\n"
    "  Do NOT use for static HTML sites — HackerNews, Wikipedia, most forums.\n"
