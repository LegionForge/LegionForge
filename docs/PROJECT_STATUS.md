...
```
make test-smoke        → 2255/2255 passing (~21s, no external services required)
...
- `tests/test_smoke.py` — **2255 tests**, no running services required, ~17s
...
make test-smoke                          # 2255 tests, ~17s
